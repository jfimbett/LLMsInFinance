...
### One dimensional TF-IDF (Term Frequency-Inverse Document Frequency)
...
Where: $f(w, d)$ Frequency of word $w$ in document $d$. $|d|$: Total number of words in document $d$. $N$: Total number of documents in the corpus, $n(w)$: Number of documents containing word $w$.
