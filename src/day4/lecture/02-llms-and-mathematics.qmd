```quarto
// filepath: c:\Users\jimbet\Dropbox\Teaching\LLM\LLMsInFinance\src\day4\lecture\02-llms-and-mathematics.qmd
---
...
::: {.column width="40%"}
![Math Capabilities](../../images/math_llm.png)
:::
...
::: {.column width="40%"}
```python
# Example of tool-augmented calculation

def calculate_bond_price(face_value, coupon_rate, 
                        yield_rate, years, frequency=2):
    ...
    coupon_pv = periodic_coupon * (1 - (1 + periodic_yield)**-periods) / periodic_yield
    
    # Calculate present value of principal
    principal_pv = face_value / (1 + periodic_yield)**periods
